...
const level = [
    { name: 'Level 1',routing:"/z",about:"You have to press the 'A' each time the current letter is 'M'. Otherwise you have to respond by pressing 'D'"},
    { name: 'Level 2',routing:"/o",about:"You have to press the 'A' each time the current letter is exactly the same as the one presented before (i.e, 1 position back in the sequence). Otherwise you have to respond by pressing 'D'"},
    { name: 'Level 3',routing:"/t",about:"You have to press the 'A' each time the current letter is exactly the same as the one presented before last (i.e, 2 position back in the sequence). Otherwise you have to respond by pressing 'D'"},
    { name: 'Level 4',routing:"/th",about:"You have to press the 'A' each time the current letter is exactly the same as the one presented three positions back in the sequence. Otherwise you have to respond by pressing 'D'"},
  ]
