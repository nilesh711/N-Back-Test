...
const Overview = () =>{
    return (
        <div>
            <h5 className="text-2xl font-serif mt-10">In this memory test , you will see a sequence of letters appearing one after another in the center of the computer screen :</h5>
            ...
            <h5 className="text-2xl font-serif mt-5">The presentation rate is fast . Every new letter appears after 2.5 seconds</h5>
        </div>
