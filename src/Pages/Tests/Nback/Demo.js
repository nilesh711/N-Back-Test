        ...
        <div  className="relative lg:w-3/4 h-full mx-auto" >
            ...
            {pageNo==3 &&
                <div>
                    ...
                    <h5 className="text-2xl font-serif mt-4">Press the letter shown previous to the current letter</h5>
            ...
            {pageNo==4 &&
                <div>
                    ...
                    <h5 className="text-2xl font-serif mt-4">Press the letter shown second previous to the current letter</h5>
