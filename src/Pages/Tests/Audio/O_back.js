...
import Audio_nbackset from '../../../Components/Audio_nbackset'
...
const O_back = (props) => {
    ...
    return (
        <div className="overflow-auto relative h-5/6">
            ...
            <Header nam={{name:"One-Back Audio Test"}} />
        </div>
        <div  className="relative lg:w-3/4 h-full mx-auto" >
            ...
            {pageNo==2 &&
                <div>
                    ...
                    <Audio_nbackset nback={1} n={10} max_right={3} min_right={2} nextPage={()=>nextPage(pageNo)} add_result={add_result}/>
                </div>
            }
            {pageNo==3 &&
                <div className="">
