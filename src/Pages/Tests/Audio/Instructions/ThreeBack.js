...
const ThreeBack = () =>{
    return (
        <div>
            <h5 className="text-2xl font-serif mt-10">For a 3-Back task, you have to press the 'A' each time the current letter is exactly the same as the one presented three positions back in the sequence. Otherwise you have to respond by pressing 'D'.</h5>
            ...
            <h5 className="ml-100 text-2xl w-96 font-serif mt-5">Here, you have to press key "M" because it is the letter shown third previous to the current letter.</h5>
        </div>
    )
}
