...
const Th_back = (props) => {
    ...
    return (
        <div className="overflow-auto relative h-5/6">
            ...
            <Header nam={{name:"Three-Back Audio Test"}} />
        </div>
        <div  className="relative lg:w-3/4 h-full mx-auto" >
            ...
            {pageNo==2 &&
                <div>
                    ...
                    <Audio_nbackset nback={3} n={25} max_right={7} min_right={5} nextPage={()=>nextPage(pageNo)} add_result={add_result}/>
                </div>
            }
